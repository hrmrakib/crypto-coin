...
const FAQ = () => {
  return (
    <section className='relative mt-28'>
      <Container>
        ...
        <div className='mt-14 grid grid-cols-1 md:grid-cols-2 gap-12'>
          ...
          <div className='flex flex-col gap-5'>
            {/* <!-- Question 1 --> */}
            <div className='bg-[#23303e] rounded-lg'>
              <button
                className='w-full flex justify-between text-left p-4 font-medium text-lg text-gray-100 focus:outline-none'
                onclick='toggleAnswer(0)'
              >
                How promote the product?
                <img src='/assets/icons/toggle-down.png' alt='' />
              </button>
              <div className='p-4 text-[#BABABA] leading-[33px]' id='answer-0'>
            ...
            <div className='bg-[#23303e] rounded-lg'>
              ...
              <div
                className='p-4 text-[#BABABA] leading-[33px] hidden'
                id='answer-1'
              >
      ...
      {/* <!-- effect --> */}
      <img
        className='absolute left-0 -bottom-[600px]'
        src='/assets/images/faq-left-blur.png'
        alt=''
      />
      {/* <!-- <img className="absolute right-0 bottom-2 rotate-180" src="/assets/images/faq-left-blur2.png" alt=""/> --> */}
      <img
        className='absolute w-44 h-48 right-5 -bottom-44'
